  ...
  const addCashDonationHandler = async (e) => {
    ...
    try {
      ...
      try {
        ...
        console.error("Donation approval email failed:", emailError);
      }
...
Donation Confirmation Link - ${window.location.origin}/donation-approvals/${donationApprovalId}`,
        ...
        console.error("Donation SMS failed:", smsError);
      }
  ...
  const handleVerifyDonation = async (donation) => {
    ...
    try {
      ...
      await setDoc(cashDocRef, {
        amount: donation.rawData.amount,
        name: donation.rawData.donorName,
        email: donation.rawData.donorEmail,
        phone: donation.rawData.donorPhone,
        donatedOn: donation.rawData.donatedOn,
        wantsCertificate: !!donation.rawData.wantsCertificate,
        donationApprovalId: donation.id,
        paymentMethod: "Cash",
        timestamp: nowIso,
        verifiedAt: nowIso,
      });
