                ...
                <div>
                  ...
                  <div className="flex items-center gap-2 mb-1">
                    {activity.volunteerStatus === "accepting" ? (
                      <span className="px-2 py-1 bg-[#e6f4ea] text-[#15653b] text-[10px] font-bold rounded-md tracking-wide">
                        {translations.accepting_volunteers || "Accepting"} ({activity.volunteers.current}/{activity.volunteers.needed})
                      </span>
                    ) : (
                      <span className="px-2 py-1 bg-gray-100 text-gray-500 text-[10px] font-bold rounded-md tracking-wide">
                        {translations.not_accepting_volunteers || "Closed"}
                      </span>
                    )}
                  </div>
