...
import { collection, getDocs, addDoc, doc, getDoc, Timestamp, updateDoc, query, where } from 'firebase/firestore';
...
export async function getCampaignsByNgo(ngoId) {
  const q = query(campaignsCollection, where("ngoId", "==", ngoId));
