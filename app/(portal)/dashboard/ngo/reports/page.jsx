      ...
      <Tabs defaultValue="charts" className="space-y-4">
            ...
            <Card>
              ...
              <CardContent>
                <p className="mb-4 text-sm text-muted-foreground">
                  Generate charts from your donations and activities data.
                  Select your data source and chart type, then download as PNG.
                </p>
        ...
        <TabsContent value="exports">
          <Card>
            ...
            <CardContent>
              <p className="mb-4 text-sm text-muted-foreground">
                This section will allow you to export detailed reports as PDF or
                CSV. Currently, you can generate and download charts from the
                Charts & Graphs tab.
              </p>
            </CardContent>
          </Card>
