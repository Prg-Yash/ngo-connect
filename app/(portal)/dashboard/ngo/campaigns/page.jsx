...
import { getCampaignsByNgo, createCampaign, uploadImage } from '@/lib/campaign';
  ...
  useEffect(() => {
    async function loadCampaigns() {
      try {
        ...
        const ngoId = userDoc.data()?.ngoId || user.uid;
        setCurrentNgoId(ngoId);

        const campaignsData = await getCampaignsByNgo(ngoId);
    ...
    // Check auth state properly or attempt to load if already authed
